...
public class Dialog extends android.app.Dialog {
     ...
     */
    public static final int TITLE = Util.generateViewId();
    /**
     * The viewId of positive action button.
     */
    public static final int ACTION_POSITIVE = Util.generateViewId();
    /**
     * The viewId of negative action button.
     */
    public static final int ACTION_NEGATIVE = Util.generateViewId();

    /**
     * The viewId of neutral action button.
     */
    public static final int ACTION_NEUTRAL = Util.generateViewId();

    public Dialog(Context context) {
        this(context, R.style.Material_App_Dialog_TimePicker_Light);
    }
...
//        mDialogVerticalPadding = Util.dpToPx(context, 24);
        ...
        mActionOuterPadding = Util.dpToPx(context, 16);
        mDialogHorizontalPadding = Util.dpToPx(context, 40);
        mDialogVerticalPadding = Util.dpToPx(context, 72);
        ...
        backgroundColor(Util.windowBackground(context, 0xFFFFFFFF));
        elevation(Util.dpToPx(context, 4));
        cornerRadius(Util.dpToPx(context, 2));
        dimAmount(0.5f);
        ...
        dividerHeight(Util.dpToPx(context, 1));
     ...
     */
    public Dialog minute(int minute) {
     ...
     *
     * @param listener The {@linkTimePickerDialog.OnTimeChangedListener} will be called.
     */
    public Dialog onTimeChangedListener(OnTimeChangedListener listener) {
...
//        RippleDrawable drawable = new RippleDrawable.Builder(getContext(), resId).build();
        return positiveActionBackground(null);
    }
...
//        RippleDrawable drawable = new RippleDrawable.Builder(getContext(), resId).build();
        return negativeActionBackground(null);
    }
...
//        RippleDrawable drawable = new RippleDrawable.Builder(getContext(), resId).build();
        return neutralActionBackground(null);
    }
    ...
    private class DialogCardView extends CardView {
        ...
        protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
            ...
            if (mNeutralAction.getVisibility() == View.VISIBLE) {
                ...
                neutralActionWidth = mNegativeAction.getMeasuredWidth();
        ...
        protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
            ...
            boolean hasAction = mNegativeAction.getVisibility() == View.VISIBLE || mPositiveAction.getVisibility() == View.VISIBLE || mNeutralAction.getVisibility() == View.VISIBLE;
            if (hasAction)
    ...
    public static class Builder implements DialogFragment.Builder, Parcelable, OnTimeChangedListener {
