...
public class TimePicker extends View {
    ...
    protected void init(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes){
        ...
        mBackgroundColor = getColor(Util.colorPrimary(context, 0xFF000000), 0.25f);
        mSelectionColor = Util.colorPrimary(context, 0xFF000000);
...
//            mStyleId = ThemeManager.getStyleId(context, attrs, defStyleAttr, defStyleRes);
    ...
    protected void applyStyle(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes){
        ...
        if(mSelectionRadius < 0)
            mSecondInnerRadius = Util.dpToPx(context, 8);

        if(mTickSize < 0)
            mTickSize = Util.dpToPx(context, 1);
...
//            ThemeManager.getInstance().unregisterOnThemeChangedListener(this);
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        mInnerRadius = mOuterRadius - mSelectionRadius - Util.dpToPx(getContext(), 4);
    ...
    public void draw(Canvas canvas) {
        ...
        if(!mRunning){
            ...
            int textOutColor = getColor(mTextColor, 1f - mAnimProgress);
            int textHighlightOutColor= getColor(mTextHighlightColor, 1f - mAnimProgress);
            int textInColor = getColor(mTextColor, mAnimProgress);
            int textHighlightInColor= getColor(mTextHighlightColor, mAnimProgress);
            float outOffset;
            float inOffset;
            float outAngle;
            float inAngle;
            ...
            mPaint.setColor(getColor(mSelectionColor, 1f - mAnimProgress));
            ...
            mPaint.setStyle(Paint.Style.FILL);
            mPaint.setColor(getColor(mSelectionColor, mAnimProgress));
    ...
    static class SavedState extends BaseSavedState {
        ...
        /**
         * Constructor called from {@linkSwitch#onSaveInstanceState()}
         */
